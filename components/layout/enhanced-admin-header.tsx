...
export function AdminHeader() {
  ...
  return (
    <header className="admin-header flex h-14 shrink-0 items-center gap-2 border-b border-zinc-800/50 bg-black/95 backdrop-blur-xl sticky top-0 z-30 w-full">
      <div className="flex w-full items-center gap-2 pl-2 pr-4 lg:gap-4 lg:pr-6">
        {/* Hamburger Trigger */}
        <SidebarTrigger className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:hover:bg-accent/50 size-7 p-2 hover:bg-zinc-900 rounded-lg transition-all duration-200 text-zinc-400 hover:text-white" />
