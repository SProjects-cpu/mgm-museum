...
const APP_EMAIL = MUSEUM_INFO.email;
const APP_PHONE = MUSEUM_INFO.phone;
const APP_PHONE_2 = '+91 98765 43210'; // Secondary contact number

export function ContactPage() {
	const socialLinks = [
		{
			icon: GithubIcon,
			href: 'https://github.com/mgm-museum',
			label: 'GitHub',
		},
		{
			icon: TwitterIcon,
			href: 'https://twitter.com/mgm_museum',
			label: 'Twitter',
		},
		{
			icon: LinkedinIcon,
			href: 'https://linkedin.com/company/mgm-museum',
			label: 'LinkedIn',
		},
		{
			icon: InstagramIcon,
			href: 'https://instagram.com/mgm_museum',
			label: 'Instagram',
		},
	];
			...
			<div className="mx-auto h-full max-w-6xl lg:border-x">
				...
				<div className="flex grow flex-col justify-center px-4 md:px-6 pt-32 pb-16">
					...
					<p className="text-muted-foreground mb-5 text-base">
						Contact the support team at MGM Museum.
					</p>
				</div>
				<BorderSeparator />
				<div className="grid md:grid-cols-3">
					...
					<Box
						icon={MapPin}
						title="Office"
						description="Drop by our museum for a visit."
					>
						<span className="font-mono text-base font-medium tracking-wide">
							{MUSEUM_INFO.address.street}, {MUSEUM_INFO.address.city}, {MUSEUM_INFO.address.state} {MUSEUM_INFO.address.pincode}
						</span>
					</Box>
					<Box
						icon={Phone}
