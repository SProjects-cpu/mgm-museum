...
export default function NotFoundPage() {
  ...
  return (
    <div className="w-full h-screen bg-white overflow-x-hidden flex justify-center items-center relative page-not-found-container" style={{ backgroundColor: '#ffffff' }}>
      <MessageDisplay />
      <CharactersAnimation />
      <CircleAnimation />
    </div>
...
function MessageDisplay() {
  ...
  return (
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
      ...
      >
        <div className="text-[35px] font-semibold m-[1%] not-found-title" style={{ color: '#111827' }}>
          Page Not Found
        </div>
        <div className="text-[80px] font-bold m-[1%] not-found-number" style={{ color: '#111827' }}>
          404
        </div>
        <div className="text-[15px] w-1/2 min-w-[40%] text-center m-[1%] not-found-message" style={{ color: '#1f2937' }}>
          The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.
        </div>
        <div className="flex gap-6 mt-8">
          <button
            onClick={handleGoHome}
            className="bg-blue-600 text-white hover:bg-blue-700 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105"
          >
...
function CharactersAnimation() {
  ...
  useEffect(() => {
    // Define stick figures with their properties - using local SVG assets
