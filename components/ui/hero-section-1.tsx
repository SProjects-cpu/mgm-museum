                        ...
                        <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
                            <div>
                                <Link
                                    ...
                                    <span className="font-medium">Introducing MGM Museum</span>
                                </Link>
                                <h1 className="mx-auto mt-8 max-w-3xl text-balance text-4xl font-bold tracking-tight sm:text-5xl">Experience Science Like Never Before</h1>
                                <p className="text-muted-foreground mx-auto my-6 max-w-xl text-balance text-xl">Discover the wonders of science through interactive exhibits, planetarium shows, and immersive experiences.</p>
                                ...
                                <div className="flex items-center justify-center gap-3">
                                    <Button
                                        ...
                                        <Link href="/plan-visit">
                                            <span className="text-nowrap">Plan Your Visit</span>
                                        </Link>
                                    </Button>
                                    <Button
                                        asChild
                                        ...
                                        <Link href="/exhibitions">
                                            <span className="text-nowrap">Explore Exhibitions</span>
                                        </Link>
                                    </Button>
                                </div>
                            </div>
                            ...
                            <div className="relative z-10 mx-auto max-w-5xl px-6">
                                <div className="mt-12 md:mt-16">
                                    <div className="bg-background rounded-(--radius) relative mx-auto overflow-hidden border border-transparent shadow-lg shadow-black/10 ring-1 ring-black/10">
                                        <Image
                                            src="https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=2880&h=1842&fit=crop&crop=center"
                                            alt="MGM Museum Science Center - Interactive exhibits and planetarium"
                                            width="2880"
                                            height="1842"
