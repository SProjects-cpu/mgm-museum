...
export default function LoginCardBackup() {
  ...
  return (
    <div className="w-[400px] bg-gray-800 rounded-lg border border-gray-700 p-8">
      {/* Header Section */}
      <div className="mb-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input 
            ...
            required
            disabled={loading}
            className="bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-gray-500 rounded-md h-12 px-4"
          />
        </div>
        ...
        <div className="flex justify-between pt-6">
          <Button 
            ...
            onClick={() => router.push('/')}
            disabled={loading}
            className="bg-gray-700 border-gray-600 text-white hover:bg-gray-600 rounded-md px-6 py-2"
          >
            Cancel
          </Button>
          <Button 
            type="submit"
            disabled={loading}
            className="bg-gray-200 text-black hover:bg-gray-100 rounded-md px-6 py-2"
          >
            {loading ? (
              <>
